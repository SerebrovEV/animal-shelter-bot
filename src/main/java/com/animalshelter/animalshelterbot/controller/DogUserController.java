 ...
 * <br>
 * Запрос через {@link Update#callbackQuery()} осуществляется по значению  {@link Callback#DOG_CONTACT_INFO}
 * <br>
 */
@Component
...
public class DogUserController implements CommandController {
    ...
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callback.DOG_CONTACT_INFO)
