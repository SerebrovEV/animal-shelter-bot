...
public class StartController implements CommandController {
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callbacks.START_MENU)
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callbacks.DOG_MENU)
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callbacks.CAT_MENU)
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callbacks.DOG_INFO_MENU)
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callbacks.CAT_INFO_MENU)
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callbacks.DOG_ADOPTION_INFO_MENU)
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callbacks.CAT_ADOPTION_INFO_MENU)
