...
/**
 * <i>Контроллер обработки навигации по боту. Отвечает за ответ на все {@link com.animalshelter.animalshelterbot.handler.Callback}`и-меню</i> <br>
 */
@Component
...
public class StartController implements CommandController {
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callback.START_MENU)
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callback.DOG_MENU)
    public SendMessage dogMenu(CallbackQuery callbackQuery) {
        return new SendMessage(callbackQuery.from().id(), DOG_MENU_TEXT)
                .replyMarkup(new InlineKeyboardMarkup()
                    .addRow(new InlineKeyboardButton(SHELTER_COMMON_INFO_BUTTON_TEXT).callbackData(Callback.DOG_INFO_MENU.name()))
                    .addRow(new InlineKeyboardButton(ADOPTION_INFO_BUTTON_TEXT).callbackData(Callback.DOG_ADOPTION_INFO_MENU.name()))
                    .addRow(new InlineKeyboardButton(KEEPING_PET_BUTTON_TEXT).callbackData(Callback.DOG_REPORT.name()))
                    .addRow(
                            new InlineKeyboardButton(CALL_VOLUNTEER_BUTTON_TEXT).callbackData(Callback.CALL_VOLUNTEER.name()),
                            new InlineKeyboardButton(BACK_BUTTON_TEXT).callbackData(Callback.START_MENU.name())
                    )
                );
    }
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callback.CAT_MENU)
    public SendMessage catMenu(CallbackQuery callbackQuery) {
        return new SendMessage(callbackQuery.from().id(), CAT_MENU_TEXT)
                .replyMarkup(new InlineKeyboardMarkup()
                        .addRow(new InlineKeyboardButton(SHELTER_COMMON_INFO_BUTTON_TEXT).callbackData(Callback.CAT_INFO_MENU.name()))
                        .addRow(new InlineKeyboardButton(ADOPTION_INFO_BUTTON_TEXT).callbackData(Callback.CAT_ADOPTION_INFO_MENU.name()))
                        .addRow(new InlineKeyboardButton(KEEPING_PET_BUTTON_TEXT).callbackData(Callback.CAT_REPORT.name()))
                        .addRow(
                                new InlineKeyboardButton(CALL_VOLUNTEER_BUTTON_TEXT).callbackData(Callback.CALL_VOLUNTEER.name()),
                                new InlineKeyboardButton(BACK_BUTTON_TEXT).callbackData(Callback.START_MENU.name())
                        )
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callback.DOG_INFO_MENU)
    public SendMessage dogInfoMenu(CallbackQuery callbackQuery) {
        return new SendMessage(callbackQuery.from().id(), DOG_SHELTER_INFO_TEXT)
                .replyMarkup(new InlineKeyboardMarkup()
                    .addRow(new InlineKeyboardButton(SHELTER_INFO_BUTTON_TEXT).callbackData(Callback.DOG_SHELTER_INFO.name()))
                    .addRow(new InlineKeyboardButton(SCHEDULE_BUTTON_TEXT).callbackData(Callback.DOG_SCHEDULE_INFO.name()))
                    .addRow(new InlineKeyboardButton(CAR_BUTTON_TEXT).callbackData(Callback.DOG_CAR_INFO.name()))
                    .addRow(new InlineKeyboardButton(SAFETY_INFO_BUTTON_TEXT).callbackData(Callback.DOG_SHELTER_SAFETY_INFO.name()))
                    .addRow(new InlineKeyboardButton(GET_CONTACTS_BUTTON_TEXT).callbackData(Callback.DOG_CONTACT_INFO.name()))
                    .addRow(
                            new InlineKeyboardButton(CALL_VOLUNTEER_BUTTON_TEXT).callbackData(Callback.CALL_VOLUNTEER.name()),
                            new InlineKeyboardButton(BACK_BUTTON_TEXT).callbackData(Callback.DOG_MENU.name())
                    )
                );
    }
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callback.CAT_INFO_MENU)
    public SendMessage catInfoMenu(CallbackQuery callbackQuery) {
        return new SendMessage(callbackQuery.from().id(), CAT_SHELTER_INFO_TEXT)
                .replyMarkup(new InlineKeyboardMarkup()
                        .addRow(new InlineKeyboardButton(SHELTER_INFO_BUTTON_TEXT).callbackData(Callback.CAT_SHELTER_INFO.name()))
                        .addRow(new InlineKeyboardButton(SCHEDULE_BUTTON_TEXT).callbackData(Callback.CAT_SCHEDULE_INFO.name()))
                        .addRow(new InlineKeyboardButton(CAR_BUTTON_TEXT).callbackData(Callback.CAT_CAR_INFO.name()))
                        .addRow(new InlineKeyboardButton(SAFETY_INFO_BUTTON_TEXT).callbackData(Callback.CAT_SHELTER_SAFETY_INFO.name()))
                        .addRow(new InlineKeyboardButton(GET_CONTACTS_BUTTON_TEXT).callbackData(Callback.CAT_CONTACT_INFO.name()))
                        .addRow(
                                new InlineKeyboardButton(CALL_VOLUNTEER_BUTTON_TEXT).callbackData(Callback.CALL_VOLUNTEER.name()),
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callback.DOG_ADOPTION_INFO_MENU)
    public SendMessage dogAdoptionInfoMenu(CallbackQuery callbackQuery) {
        return new SendMessage(callbackQuery.from().id(), DOG_ADOPTION_INFO_TEXT)
                .replyMarkup(new InlineKeyboardMarkup()
                        .addRow(new InlineKeyboardButton(FIRST_MEETING_RULES_BUTTON_TEXT).callbackData(Callback.DOG_MEETING_RULES_INFO.name()))
                        .addRow(new InlineKeyboardButton(DOCUMENT_LIST_BUTTON_TEXT).callbackData(Callback.DOG_DOCUMENT_LIST.name()))
                        .addRow(new InlineKeyboardButton(TRANSPORTATION_RECOMMENDATIONS_BUTTON_TEXT).callbackData(Callback.DOG_TRANSPORTATION_RECOMMENDATION.name()))
                        .addRow(new InlineKeyboardButton(YOUNG_HOUSING_RECOMMENDATIONS_BUTTON_TEXT).callbackData(Callback.DOG_YOUNG_HOUSING_RECOMMENDATION.name()))
                        .addRow(new InlineKeyboardButton(HOUSING_RECOMMENDATIONS_BUTTON_TEXT).callbackData(Callback.DOG_HOUSING_RECOMMENDATION.name()))
                        .addRow(new InlineKeyboardButton(DISABLED_HOUSING_RECOMMENDATIONS_BUTTON_TEXT).callbackData(Callback.DOG_DISABLED_HOUSING_RECOMMENDATION.name()))
                        .addRow(new InlineKeyboardButton(DECLINE_CAUSES_BUTTON_TEXT).callbackData(Callback.DOG_DECLINE_CAUSES.name()))
                        .addRow(new InlineKeyboardButton(CYNOLOGIST_ADVICES_BUTTON_TEXT).callbackData(Callback.DOG_CYNOLOGIST_ADVICES.name()))
                        .addRow(new InlineKeyboardButton(CYNOLOGIST_RECOMMENDATIONS_BUTTON_TEXT).callbackData(Callback.DOG_CYNOLOGIST_RECOMMENDATION.name()))
                        .addRow(new InlineKeyboardButton(GET_CONTACTS_BUTTON_TEXT).callbackData(Callback.DOG_CONTACT_INFO.name()))
                        .addRow(
                                new InlineKeyboardButton(CALL_VOLUNTEER_BUTTON_TEXT).callbackData(Callback.CALL_VOLUNTEER.name()),
                                new InlineKeyboardButton(BACK_BUTTON_TEXT).callbackData(Callback.DOG_MENU.name())
     ...
     */
    @com.animalshelter.animalshelterbot.handler.Callback(name = Callback.CAT_ADOPTION_INFO_MENU)
    public SendMessage catAdoptionInfoMenu(CallbackQuery callbackQuery) {
        return new SendMessage(callbackQuery.from().id(), CAT_ADOPTION_INFO_TEXT)
                .replyMarkup(new InlineKeyboardMarkup()
                        .addRow(new InlineKeyboardButton(FIRST_MEETING_CAT_RULES_BUTTON_TEXT).callbackData(Callback.CAT_MEETING_RULES_INFO.name()))
                        .addRow(new InlineKeyboardButton(DOCUMENT_LIST_BUTTON_TEXT).callbackData(Callback.CAT_DOCUMENT_LIST.name()))
                        .addRow(new InlineKeyboardButton(TRANSPORTATION_RECOMMENDATIONS_BUTTON_TEXT).callbackData(Callback.CAT_TRANSPORTATION_RECOMMENDATION.name()))
                        .addRow(new InlineKeyboardButton(YOUNG_HOUSING_RECOMMENDATIONS_BUTTON_TEXT).callbackData(Callback.CAT_YOUNG_HOUSING_RECOMMENDATION.name()))
                        .addRow(new InlineKeyboardButton(HOUSING_RECOMMENDATIONS_BUTTON_TEXT).callbackData(Callback.CAT_HOUSING_RECOMMENDATION.name()))
                        .addRow(new InlineKeyboardButton(DISABLED_HOUSING_RECOMMENDATIONS_BUTTON_TEXT).callbackData(Callback.CAT_DISABLED_HOUSING_RECOMMENDATION.name()))
                        .addRow(new InlineKeyboardButton(DECLINE_CAUSES_BUTTON_TEXT).callbackData(Callback.CAT_DECLINE_CAUSES.name()))
                        .addRow(new InlineKeyboardButton(GET_CONTACTS_BUTTON_TEXT).callbackData(Callback.CAT_CONTACT_INFO.name()))
                        .addRow(
                                new InlineKeyboardButton(CALL_VOLUNTEER_BUTTON_TEXT).callbackData(Callback.CALL_VOLUNTEER.name()),
                                new InlineKeyboardButton(BACK_BUTTON_TEXT).callbackData(Callback.CAT_MENU.name())
